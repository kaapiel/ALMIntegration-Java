...
public class TerminalWindow {
	...
	public void update(final String command, final String returned,
		...
		updateTerminal();
		try {
			Thread.sleep(950); // Feio, mas foi a nica forma que encontrei de dar tempo para bater uma screenshot.
							   // Se tiver outra idia, no hesite!
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					// Utils.captureMainframeScreenshot(textPane3270);
